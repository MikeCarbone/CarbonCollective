    ...
    <div className="footer__copy">
      <div className="footer__wrapper generic__standard-wrapper generic__standard-wrapper--vert">
        ...
        <p className="footer__love">
          Built with <span role="img" className="generic__emoji" aria-label="love">🔥</span> by <a className="footer__love-link generic__text-link" href="https://twitter.com/carbnology" target="_blank" rel="noopener noreferrer">Mike Carbone</a>
        </p>
      </div>
    </div>
  </footer>
