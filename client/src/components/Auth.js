    ...
    return (
      <>
        ...
        <div className="login">
          ...
          <input autoCapitalize="none" id="username" className="generic__input login__input" type="text" name="username" placeholder="Username" onChange={this.handleChange}/>
          <input autoCapitalize="none" id="password" className="generic__input login__input" type="password" name="password" placeholder="Password" onChange={this.handleChange}/>
