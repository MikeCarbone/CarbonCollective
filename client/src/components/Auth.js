  ...
  render() {
    ...
    return (
      <>
        {this.state.toast}
        <div className="login">
          <p className="login__text">Hey man! Let's see if you have access to this.</p>
          ...
          <p className="login__text login__text--sub">Not an admin? Whatcha doing here!? Let's talk on Twitter <a className="generic__text-link" href="https://twitter.com/carbonology_" target="_blank" rel="noreferrer noopener">@carbonology_</a> and see what's up.</p>
        </div>
      </>
    )
  }
